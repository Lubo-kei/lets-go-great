...
function Home() {
  return (
    <div className="
  min-h-screen
  bg-[radial-gradient(circle_at_15%_20%,#E9FF7A_0%,transparent_35%),linear-gradient(120deg,#D0FE1D_0%,#DDF56D_45%,#EAEBDD_100%)]
">
      <Header />
...
>
          ...
          <div className="border-4 border-[#A8A8A8] bg-white rounded-3xl pt-7 pb-14 px-12 w-full max-w-[460px] ml-auto mr-0">
